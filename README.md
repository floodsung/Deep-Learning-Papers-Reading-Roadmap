...
**[22]** Lu, Jun, Wei Ma, and Boi Faltings. "CompNet: Neural networks growing via the compact network morphism." arXiv preprint arXiv:1804.10316 (2018). [[pdf]](https://arxiv.org/abs/1804.10316) **(Modify previously trained network to reduce training epochs)** :star::star::star:
