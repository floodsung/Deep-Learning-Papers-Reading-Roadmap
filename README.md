...
**[2]** Wang, Haohan, and Bhiksha Raj. "**On the Origin of Deep Learning**." arXiv preprint arXiv:1702.07800 (2017). [[pdf]](https://arxiv.org/abs/1702.07800) **(A comprehensive review from a novel perspective)** :star::star::star::star::star:
...
**[7]** Szegedy, Christian, et al. "**Going deeper with convolutions**." Proceedings of the IEEE Conference on Computer Vision and Pattern Recognition. 2015. [[pdf]](http://www.cv-foundation.org/openaccess/content_cvpr_2015/papers/Szegedy_Going_Deeper_With_2015_CVPR_paper.pdf) **(GoogLeNet)** :st5r::star::star:
